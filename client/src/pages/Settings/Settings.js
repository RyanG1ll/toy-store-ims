  ...
  return (
    <div className="settings-page">
      ...
      <section className="settings-section">
        ...
        <div className="settings-options" role="radiogroup" aria-label="Font size">
          {[
      ...
      <section className="settings-section">
        ...
        <div className="settings-options" role="radiogroup" aria-label="Page zoom">
          {[
      ...
      <section className="settings-section">
        ...
        <div className="settings-options" role="radiogroup" aria-label="Colour theme">
          {[
            ...
            <label key={option.value} className="settings-option settings-option-card">
              <input
                type="radio"
                name="theme"
                value={option.value}
