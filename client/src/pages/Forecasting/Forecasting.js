...
function Forecasting() {
  ...
  // Filter forecasts by search term (name or SKU)
        ...
        <>
          ...
          <div className="forecasting-controls">
            <div className="forecasting-search">
              <label htmlFor="forecast-search" className="sr-only">Search products</label>
              <input
                id="forecast-search"
                type="text"
            ...
            <div className="forecasting-toggle-buttons">
              <button className="btn btn-small" onClick={expandAll} aria-label="Expand all product cards">
                Expand All
              </button>
              <button className="btn btn-small" onClick={collapseAll} aria-label="Collapse all product cards">
                Collapse All
              </button>
            </div>
          </div>
          ...
          {filteredForecasts.length === 0 ? (
            ...
            <div className="forecast-cards" role="region" aria-label="Product forecasting cards">
              {filteredForecasts.map((f) => {
                const isExpanded = expandedCards[f.product_id] || false;
                ...
                return (
                  <article key={f.product_id} className="forecast-card"
                    ...
                    <button
                      ...
                      onClick={() => toggleCard(f.product_id)}
                      aria-expanded={isExpanded}
                      aria-controls={`forecast-body-${f.product_id}`}
                    >
                      ...
                      <div className="forecast-header-right">
                        ...
                        <span className="forecast-stock-summary">
                          {f.current_stock} units
                        </span>
                        <span className={`forecast-chevron ${isExpanded ? 'expanded' : ''}`} aria-hidden="true">
                          ▾
                        </span>
                      </div>
                    </button>
                    ...
                    {/* Expandable body */}
                    {isExpanded && (
                      <div className="forecast-card-body" id={`forecast-body-${f.product_id}`}>
                        ...
                        <dl className="forecast-metrics-list">
                          ...
                          <div className="forecast-metric">
                            <dt className="metric-label">
                              Days of Stock Left
                              <Tooltip content={educationalContent.daysOfStockLeft} />
                            </dt>
                        ...
                        <dl className="forecast-metrics-list">
                          <div className="forecast-metric">
                            <dt className="metric-label">
                              Avg Monthly Demand
                              <Tooltip content={educationalContent.estDemand} />
                            </dt>
                          ...
                          <div className="forecast-metric">
                            <dt className="metric-label">
                              Avg Lead Time
                              <Tooltip content={educationalContent.avgLeadTime} />
                            </dt>
                        ...
                        <dl className="forecast-metrics-list">
                          ...
                          <div className="forecast-metric">
                            <dt className="metric-label">
                              Ordering Cost
                              <Tooltip content={educationalContent.orderingCost} />
                            </dt>
